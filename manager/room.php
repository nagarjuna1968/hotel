				...
				<table id = "table" class = "table table-bordered">
					...
					?>	
						<tr>
							...
							<td>
                                <center>
                                    <?php if( managerRoles('edit_room') ): ?>
                                        <a class = "btn btn-warning" href = "edit_room.php?room_id=<?php echo $fetch['room_id']?>"><i class = "glyphicon glyphicon-edit"></i> Edit</a>
                                    <?php endif; ?>
                                    <?php if( managerRoles('delete_room') ): ?>
                                        <a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "delete_room.php?room_id=<?php echo $fetch['room_id']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a>
                                    <?php endif; ?>
                                </center>
                            </td>
						</tr>
