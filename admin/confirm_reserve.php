				...
				<form method = "POST" enctype = "multipart/form-data" action = "save_form.php?transaction_id=<?php echo $fetch['transaction_id']?>">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-2">
                            ...
                            <input type="text" name="name_on_card" class="form-control" id="name_on_card" disabled value="<?= $fetch['name_on_card'] ?>">
                        </div>
                        <div class="col-12 col-md-2">
                            <label for="credit_card_number">Card Number</label>
                            <input type="text" name="credit_card_number" class="form-control" id="credit_card_number" disabled value="<?= $fetch['credit_card_number'] ?>">
                        </div>
                        <div class="col-12 col-md-2">
                            <label for="expiry">Expiry</label>
                            <input type="text" name="expiry" class="form-control" id="expiry" disabled value="<?= $fetch['expiry_month'].'-'.$fetch['expiry_year'] ?>">
                        </div>
                        <div class="col-12 col-md-2">
                            <label for="cvv">CVV</label>
                            <input type="text" name="cvv" class="form-control" id="cvv" disabled value="<?= $fetch['cvv'] ?>">
                        </div>
                    </div>
                    <br>
                    <h3>REVIEW</h3>
