	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3 style="color: #FF6347"><b>ABOUT US</b></h3></strong>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><h4 style = "color:#FF6347;"><b>Standard</b></h4></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><h4 style = "color:#FF6347;"><b>Extra Bed</b></h4></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><h4 style = "color:#FF6347;"><b>Superior</b></h4></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><h4 style = "color:#FF6347;"><b>Super Deluxe</b></h4></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><h4 style = "color:#FF6347;"><b>Jr. Suite</b></h4></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><h4 style = "color:#FF6347;"><b>Executive Suite</b></h4></center>
