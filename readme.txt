...
5. Extract the file and copy "online " folder
...
7.Run the script http://localhost/online


**LOGIN DETAILS** 
for admin acess http://localhost/online/admin
Admin
user: admin
pass: admin
Manager
url: http://localhost/online/manager/
user:manager
pass:manager